  ...
  return (
    <div className="border p-10 rounded-xl text-left">
      ...
      <div className="space-x-3 mb-4">
        <button className="btn border border-[#7E90FE] bg-transparent text-[#7E90FE] text-base font-extrabold">
          {remote_or_onsite}
        </button>
        <button className="btn border border-[#7E90FE] bg-transparent text-[#7E90FE] text-base font-extrabold">
          {job_type}
      ...
      <Link to={`job/${id}`}>
        <button className="btn bg-gradient-to-r from-[#7E90FE] to-[#9873FF] text-white text-xl font-extrabold ">
          View Details
        </button>
      </Link>
    </div>
